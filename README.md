...
2. **Before any frontend work: codebase scan** — detects your framework, styling approach, testing setup, and component patterns so decisions are grounded in what actually exists.
...
| `codebase-scan` | Detects project framework, styling, testing, component patterns before decisions |
